...
sudo apt-get install -y build-essential libtool autopoint autoconf bison gtk-doc-tools cmake libboost-all-dev gcc-multilib libedit-dev libclang-dev libcairo2-dev &&
